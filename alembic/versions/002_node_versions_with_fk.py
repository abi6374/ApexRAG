...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("superseded_by", sa.String(36), sa.ForeignKey("node_versions.version_id", ondelete="SET NULL"), nullable=True),
        sa.Column("previous_version", sa.String(36), sa.ForeignKey("node_versions.version_id", ondelete="SET NULL"), nullable=True),
    ...
    op.create_index("ix_node_versions_effective", "node_versions", ["node_id", "effective_from", "effective_to"])
    ...
    op.create_table(
        ...
        sa.Column("doc_id", sa.String(255), nullable=False),
        sa.Column("tenant_id", sa.String(255), nullable=False, server_default="default"),
        sa.Column("source_version_id", sa.String(36), sa.ForeignKey("node_versions.version_id", ondelete="CASCADE"), nullable=False),
        sa.Column("target_version_id", sa.String(36), sa.ForeignKey("node_versions.version_id", ondelete="SET NULL"), nullable=True),
