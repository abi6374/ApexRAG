...
class VerificationReport:
    ...
    def passed(self) -> bool:
        return all(
            i.severity not in (CheckSeverity.ERROR, CheckSeverity.WARNING) for i in self.issues
        )
    ...
    async def verify_document(
        ...
        *,
        ...
        if not tenant_context:
            ...
            raise MissingTenantContextError("tenant_context is required for verify_document.")
            ...
            for i in range(len(subject_facts)):
                for j in range(i + 1, len(subject_facts)):
                    ...
                    if (
                        ...
                        or b.superseded_by == a.fact_id
                        or a.parent_fact_id == b.fact_id
                        or b.parent_fact_id == a.fact_id
                    ):
                        continue
