...
class LangChainBaseline:
    ...
    async def query(self, question: str, text_context: str) -> BaselineResult:
        try:
            ...
            return BaselineResult(f"Mocked LangChain answer for: {question[:30]}...", [text_context[:200]])
...
class LlamaIndexBaseline:
    ...
    async def query(self, question: str, text_context: str) -> BaselineResult:
        try:
            ...
            return BaselineResult(f"Mocked LlamaIndex answer for: {question[:30]}...", [text_context[:200]])
